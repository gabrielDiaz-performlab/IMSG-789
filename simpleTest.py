...
pl_left = vizshape.addPlane(
		size = [planeWidth/2.0,planeHeight/2.0],
...
pl_left.setEuler([headEuler_YPR[0],0+headEuler_YPR[1],headEuler_YPR[2]])
pl_right.setEuler([headEuler_YPR[0],0+headEuler_YPR[1],headEuler_YPR[2]])
